...
CREATE TABLE `grant` (
  ...
  `grant_amount` decimal(8,5) DEFAULT NULL,
...
CREATE TABLE `project_grants` (
  ...
  `partial_amount` decimal(8,5) DEFAULT NULL,
  PRIMARY KEY (`idx`),
  ...
  CONSTRAINT `project_grants_grant_id_fk` FOREIGN KEY (`grant_id`) REFERENCES `grant` (`grant_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_info` (
  ...
  `excess_hour_charges` decimal(8,5) DEFAULT '0.00000',
...
--
-- Table structure for table `user_project_contrib`
--
...
CREATE TABLE `user_project_contrib` (
  ...
  CONSTRAINT `user_project_contrib_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Dumping data for table `user_project_contrib`
--
...
-- Dump completed on 2015-09-28 13:31:40
