...
--
-- Host: ovzve25-56.appstate.edu    Database: rpt
-- ------------------------------------------------------
...
--
-- Table structure for table `funded_grant`
--
...
--
-- Dumping data for table `funded_grant`
--
...
CREATE TABLE `user_project_contrib` (
  ...
  `hours_contributed` double(5,2) DEFAULT '0.00',
...
-- Dump completed on 2015-12-08 14:32:31
